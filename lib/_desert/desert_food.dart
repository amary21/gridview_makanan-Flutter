...
import '../data/desert.dart';

const PrimaryColor = const Color(0xFFFF0D86);

class DesertFood extends StatefulWidget {
  @override
  _DesertFoodState createState() => _DesertFoodState();
}

class _DesertFoodState extends State<DesertFood> {
  get makanan => Desert().makanan;
